...
with analytic_s:
    ...
    st.scatter_chart(dataset, x="Delivery_person_Age", y="multiple_deliveries", color="multiple_deliveries")

    st.area_chart(dataset, x="Delivery_person_Age", y="Time_taken(min)")
    ...
    count_df = dataset.groupby('Order_Date').size().reset_index(name='count')
